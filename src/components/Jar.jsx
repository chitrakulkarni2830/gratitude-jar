  ...
  return (
    <div className="sticky top-[60px] flex flex-col items-center">
      <div className="relative w-[340px] h-[480px]">
        ...
        {/* Notes Layer (must be rendered BEFORE Jar Body z-index wise visually, but structurally here it is z-10 inside the jar-wrap relative container) */}
        {/* Wait, if it's z-10 and JarBody is z-20, it will render correctly behind the glass. */}
        <NoteLayer />

        {/* Jar Shadow */}
        <div className="absolute bottom-[-18px] left-1/2 -translate-x-1/2 w-[250px] h-[26px] bg-glass-shadow rounded-full blur-[14px] z-0" />
      </div>
